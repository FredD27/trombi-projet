...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const slidesContainer2 = document.querySelector(".carousel2");
  const nextButton = document.querySelector(".arrow_button_next");
  const prevButton = document.querySelector(".arrow_button_prev");
  const nextButton2 = document.querySelector(".arrow_button_next2");
  const prevButton2 = document.querySelector(".arrow_button_prev2");
  ...
  //   const showSlides = (tab, containerName) => {
  //     const container = document.querySelector(containerName);

  //     tab.forEach((imagePath) => {
  ...
  //   showSlides(imagesArray, '.carousel');
  //   showSlides(imagesArray, '.carousel2');
  ...
  const showSlides = (images, containerName) => {
    const container = document.querySelector(containerName);
  ...
  showSlides(imagesArray, ".carousel");
  showSlides(imagesArray2, ".carousel2");
  ...
  function loadCurrentSlide2() {
    ...
    currentSlide.classList.add("fade-transition");
    const img = document.createElement("img");
    img.src = imagesArray2[currentSlideIndex];
    currentSlide.appendChild(img);
    slidesContainer2.appendChild(currentSlide);
  }

  function nextSlide2() {
    currentSlideIndex++;
    if (currentSlideIndex >= imagesArray2.length) {
      currentSlideIndex = 0;
    }
    loadCurrentSlide2();
    imageDescription2.textContent = descriptions2[currentSlideIndex];
  }

  function prevSlide2() {
    currentSlideIndex--;
    if (currentSlideIndex < 0) {
      currentSlideIndex = imagesArray2.length - 1;
    }
    loadCurrentSlide2();
    imageDescription2.textContent = descriptions2[currentSlideIndex];
  }
  ...
  const imageDescription2 = document.getElementById("imageDescription2");
  ...
  [
    {
      ...
      objectif: "Objectif professionnel: Devenir le maître de Javascript",
  ...
  [
    {
      ...
      objectif: "Objectif professionnel: Développeuse web riche et célèbre",
...

    {
      ...
      objectif: "Objectif professionnel: Alternance et vivre de son travail",
